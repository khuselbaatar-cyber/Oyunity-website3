...
export default function Page() {
  const features = ["HSK 1-6 түвшний онлайн курсүүд", "CSCA шалгалтын ёж сургалт", "Туршлагатай багш нар Монгол хэлээр заана", "Age-appropriate (6-17 насны хүүхдэд)", "Долоо хоног бүрийн live session", "Зэрэг өсөх боломжтой курсийн систем"];
  const covers = ["Онлайн", "Монгол хэлээр", "6-17 нас"];
  return (
    <>
      <Navbar />
      <PageHero
        eyebrow="Цахим сургалт · HSK + CSCA"
        title="Бага сурагчдад зориулсан онлайн Хятад хэлний сургалт."
        subtitle="Арван жилийн сурагчдыг (6-17 насны хүүхэд) HSK + CSCA шалгалтанд бэлдэх онлайн сургалтын төв. Эртнээс эхэлж, ирээдүйн Хятадад сурах суурийг тавиарай."
      ...
      <section className="px-[5%] py-16 md:py-24 bg-oyunity-soft">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <p className="text-5xl md:text-6xl font-bold text-oyunity-navy mb-4">Удахгүй зарлана</p>
